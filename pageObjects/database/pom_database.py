...
class Database:
    ...
    header_select_namespace = Locator.header_select_namespace_xpath
    ...
    def go_to_create_database_page(self):
        ...
        WebDriverWait(self.driver, 30).until(EC.presence_of_element_located((By.XPATH, self.mongodb_framework)))
        time.sleep(2)
        ...
        while True:
            ...
            if user_input == 'Mongodb':
                ...
                WebDriverWait(self.driver, 30).until(
                    EC.presence_of_element_located((By.XPATH, self.header_select_namespace)))
                time.sleep(2)
                break
    ...
    def advanced_database_cluster_creation(self):
        self.logger.info("Starting database cluster creation")
        self.go_to_create_database_page()
        self.choose_database_framework()
